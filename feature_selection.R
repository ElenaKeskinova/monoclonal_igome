...
plot3d(ux, col=numcodes, size=10)
palette(oldpal)

# 2d graph
ux=umap(X, n_neighbors = 20, min_dist = 0.1, spread=7,  n_epochs = 1500,
        verbose=T, n_components = 2, init = "normlaplacian",n_sgd_threads=14)
plot(ux, col=colors[numcodes], cex=2, pch=16)
